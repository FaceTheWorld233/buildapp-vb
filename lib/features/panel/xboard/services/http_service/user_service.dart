...
class UserService {
  ...
  Future<bool> validateToken(String token) async {
    try {
      ...
      // 检查返回结果中是否有 subscribe_url
      if (response['data'] != null) {
        final data = response['data'] as Map<String, dynamic>;
        return data.containsKey('subscribe_url') &&
            data['subscribe_url'] != null;
      }

      return false; // 如果没有 subscribe_url，则返回 false
    } catch (_) {
      return false; // 捕获任何异常，返回 false
    }
  }
